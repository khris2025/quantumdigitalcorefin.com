                                             ...
                                             <div class="row">
                                                <div class="col-md-6">
                                                   <div class="mb-3">
                                                      ...
                                                      <input type="number" class="form-control" id="formrow-email-input" name="accbalance" value="<?php echo e($user->accbalance); ?>">
                                                   </div>
                                                </div>
...
<?php echo $__env->make('Adminview.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u575956124/domains/globalunityaidfoundation.com/public_html/grant/resources/views/Adminview/user_modify.blade.php ENDPATH**/ ?>