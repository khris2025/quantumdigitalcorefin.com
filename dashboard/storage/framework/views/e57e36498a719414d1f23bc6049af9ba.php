...
<div class="container-fluid">
   <div class="row">
      <div class="col-12">
         ...
         <form action="<?php echo e(route('wire_transfer_add')); ?>" method="post">
            ...
            <div class="mb-3">
               <label for="recipient-account-number" class="form-label">Recipient Account Number/IBAN</label>
               <input type="text" class="form-control" name="recipient_account_number" placeholder="Enter account number or IBAN" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
               <label for="recipient-routing-number" class="form-label">Routing Number/SWIFT Code</label>
               <input type="text" class="form-control" id="recipient-routing-number" name="recipient_routing_number" placeholder="Enter routing number or SWIFT code" required>
            </div>
            <!-- Transfer Details -->
            <div class="mb-3">
            ...
            <div class="mb-3">
               ...
               <input type="password" class="form-control" id="secretCode" name="secretCode" placeholder="Enter your transfer PIN" required>
            </div>
            <!-- Submit Button -->
            <div class="d-grid">
...
<?php echo $__env->make('Userview.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u340040325/domains/redwoodglobalbk.com/public_html/dash/resources/views/Userview/wire_transfer.blade.php ENDPATH**/ ?>