...
<div class="row">
   ...
   <div class="container mt-5">
      ...
      <div class="row fixed-row">
         <div class="col-4">
            <a href="<?php echo e(route('cryptowithdrawal')); ?>" class="card mb-2">
               <div class="card mb-2">
                  <div class="card-body text-center">
                     <div class="icon-box">
...
<?php echo $__env->make('Userview.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u340040325/domains/redwoodglobalbk.com/public_html/dash/resources/views/Userview/dashboard.blade.php ENDPATH**/ ?>