                              ...
                              <table id="datatable" class="table nowrap w-100">
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td style="font-size: 16px;" class="font-w400 "><?php echo e($pending_kycs->coin_type); ?></td>
                                       <td style="font-size: 16px;" class="font-w400 ">
                                          <a href="<?php echo e(url('storage/kyc_payment_proof/' . $pending_kycs->proof)); ?>">
                                             <img id="blah" src="<?php echo e(url('storage/kyc_payment_proof/' . $pending_kycs->proof)); ?>" style="border-radius: 10%;  height: 150px;" alt="Uploaded Image">
                                          </a>
                                       </td>
...
<?php echo $__env->make('Adminview.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u575956124/domains/globalunityaidfoundation.com/public_html/grant/resources/views/Adminview/pending_kyc.blade.php ENDPATH**/ ?>