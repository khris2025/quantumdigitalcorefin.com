         ...
         <div data-simplebar class="h-100">
            ...
            <div id="sidebar-menu">
               ...
               <ul class="metismenu list-unstyled" id="side-menu">
                  ...
                  <li>
                     <a href="{{ route('pending_wiretrf') }}">
                     <i data-feather="bar-chart-2"></i>
                     <span data-key="t-dashboard">Pending Trans</span>
                     </a>
                  </li>

                  <li>
                     <a href="{{ route('fund_account') }}">
                     <i data-feather="bar-chart-2"></i>
                     <span data-key="t-dashboard">Fund account</span>
                     </a>
                  </li>

                  {{-- <li>
                     <a href="{{ route('pending_localtrf') }}">
                     <i data-feather="bar-chart-2"></i>
                  ...
                  <li>
                     <a href="{{ route('pending_carddeposit') }}">
                     <i data-feather="bar-chart-2"></i>
                  ...
                  <li>
                     <a href="{{ route('pending_chequedeposit') }}">
                     <i data-feather="bar-chart-2"></i>
                  ...
                  <li>
                     <a href="{{ route('crypto_deposit_action') }}">
                     <i data-feather="bar-chart-2"></i>
                  ...
                  <li>
                     <a href="{{ route('crypto_withdrawal') }}">
                     <i data-feather="bar-chart-2"></i>
