                  ...
                  <div class="card-body pb-0 text-center">
                     ...
                     <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex px-0 justify-content-between">
                           ...
                           <span class="mb-0">{{ $kycData->transaction_id }}</span>
                        </li>
                        <li class="list-group-item d-flex px-0 justify-content-between">
                           <strong>Date/Time</strong>
                           <span class="mb-0">{{ $kycData->dateadd }}</span>
                        </li>
                        <li class="list-group-item d-flex px-0 justify-content-between">
                           <strong>Amount to Pay</strong>
                           <span class="mb-0">${{ number_format($kyc_amount) }}</span>
                        </li>
                     </ul>
                  </div>
                           ...
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="text-center">
                                    ...
                                    <div class="mb-2" style="text-align: center; margin-top: 1%;" id="circle">   <img src="{{ url('storage/qr_images/' . $QRcode) }}" style="border-radius: 10%;  height: 150px;" alt="qrcode" />  </div>
                                    <br>
                                    <form action="{{ route('kyc_upload_proof') }}" method="post" enctype="multipart/form-data">
                                       @csrf
                                       ...
                                       @if ($kycData->status == 'unconfirmed' || $kycData->status == 'canceled')
                                          <div class="mb-4" style="text-align: center;" id="circle">
                                             <br>
                                             @if ($kycData->proof)
                                             <img id="blah" src="{{ url('storage/kyc_payment_proof/' . $kycData->proof) }}" style="border-radius: 10%;  height: 150px;" alt="Uploaded Image">
                                             @endif
                                          </div>
