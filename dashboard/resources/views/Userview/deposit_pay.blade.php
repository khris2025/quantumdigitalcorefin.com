                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card-footer">
                                    <ul>
                                       <li>
                                          <p class="card-text text-danger"><i class="fa fa-exclamation-circle" aria-hidden="true"> </i> Be aware of that this order will be cancelled, if you send any other amount.</p>
                                       </li>
