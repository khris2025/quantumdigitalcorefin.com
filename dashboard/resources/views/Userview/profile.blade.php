                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="mb-3">
                                          ...
                                          <input type="text" class="form-control" id="formrow-lastname-input" disabled value="" >
                                       </div>
                                    </div>
                                 </div>
                                 --}}
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="mb-3">
                                          ...
                                          <input type="text" class="form-control" id="formrow-email-input" name="zip_code" placeholder="Enter your Address" value="{{ Auth::user()->zip_code }}" disabled>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="mb-3">
                                          <label class="form-label" for="formrow-email-input">Date of Birth</label>
                                          <input type="text" class="form-control" id="formrow-lastname-input" name="date_of_birth"  value="{{ Auth::user()->date_of_birth }}" disabled>
                                       </div>
                                    </div>
                                 </div>
